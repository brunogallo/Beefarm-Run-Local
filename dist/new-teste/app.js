    ...
    var e = {
        ...
        652: function(e, a, t) {
            ...
            const v = (e,a)=>w("GET", e, a)
              , x = (e,a)=>w("POST", e, a);
            function y(e) {
                return v("/api/getIdByInviteCode?invite_code=" + e, {
                    params: {}
                })
            }
            function k(e) {
                return v("/api/register?code=" + e.code + "&agent_id=" + e.agent_id + "&mobile=" + e.mobile + "&operater_id=" + e.operater_id + "&time=" + e.time + "&invite_code=" + e.invite_code + "&i=" + e.i + "&s=" + e.s + "&t=" + e.t + "&language_id=" + e.language_id + "&url=" + e.url, {
                    params: {}
                })
            }
            function C(e) {
                return v("/api/setVisitCount?operater_id=" + e.operater_id, {
                    params: {}
                })
            }
            function S(e) {
                return v("/api/getNoticeData?operater_id=" + e.operater_id, {
                    params: {}
                })
            }
            function I(e) {
                return v("/api/getMarketOrder?operater_id=" + e.operater_id + "&size=" + e.size + "&page=" + e.page, {
                    params: {}
                })
            }
            function N(e) {
                return v("/api/echarts?operater_id=" + e.operater_id + "&item_id=" + e.item_id, {
                    params: {}
                })
            }
            function $(e) {
                return v("/api/getWebInfo?operater_id=" + e.operater_id, {
                    params: {}
                })
            }
            function z(e) {
                return v("/api/getOpenInstallConfig?operater_id=" + e.operater_id, {
                    params: {}
                })
            }
            function D(e) {
                return v("/api/checkOperator?operater_id=" + e.operater_id + "&agent_id=" + e.agent_id, {
                    params: {}
                })
            }
            function B(e) {
                return v("/api/getDomainInfo?domain=" + e.domain, {
                    params: {}
                })
            }
            function q(e) {
                return x("/api/sendEmailCode", {
                    data: e
                })
            }
            function L(e) {
                return v("/api/checkParams?operater_id=" + e.operater_id + "&agent_id=" + e.agent_id + "&invite_code=" + e.invite_code, {
                    params: {}
                })
            }
            function U(e) {
                return v("/api/calcClickNum?uid=" + e.uid, {
                    params: {}
                })
            }
            var T = {
            ...
            P.Z)(O, u, c, !1, null, "6ead3ed4", null)
              ...
              , F = function() {
                ...
                return a("div", [a("el-row", {
                    ...
                    on: {
                        click: function(a) {
                            console.log(e.openWebGame("email"))
                        }
                    }
            ...
            t(7822))
              ...
              , te = function() {
                ...
                return a("div", [a("el-row", {
                    ...
                    on: {
                        click: function(a) {
                            console.log(e.homeOpenWebGame("phone"))
                        }
                    }
                }, [e._v("WEB")]), a("div", {
                    staticClass: "androidGame",
              ...
              , me = {
                ...
                methods: {
                    ...
                    copy() {
                        ...
                        var c = "";
                        c = sessionStorage.getItem("loginId") ? encodeURIComponent(W.DS.encode(JSON.stringify(t))) + i : encodeURIComponent(W.DS.encode(JSON.stringify(t)));
